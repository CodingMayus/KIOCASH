...
//                 }}
//               />
//               <div className="hidden absolute inset-0 flex items-center justify-center text-4xl text-blue-600 font-bold">K</div>
//             </div>
//           </div>
...
//                 <div>
//                   <button className="w-full inline-flex justify-center py-2 px-4 border border-blue-300 rounded-md shadow-sm bg-white text-sm font-medium text-blue-700 hover:bg-blue-50">
//                     <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
//                       <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10c0 4.42 2.865 8.166 6.839 9.49.5.09.682-.218.682-.483 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.268 2.75 1.026A9.578 9.578 0 0110 2.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.026 2.747-1.026.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C17.14 18.163 20 14.42 20 10c0-5.523-4.477-10-10-10z" clipRule="evenodd" />
//                     </svg>
//                   </button>
//                 </div>
...
//           <Link href="/terms" className="text-xs text-blue-500 hover:text-blue-700">
//             Terms of Service
//           </Link>
//           <Link href="/privacy" className="text-xs text-blue-500 hover:text-blue-700">
//             Privacy Policy
//           </Link>
//           <Link href="/contact" className="text-xs text-blue-500 hover:text-blue-700">
//             Contact Us
//           </Link>
//         </div>
//         <p className="mt-2 text-xs text-blue-400">
//           © 2025 KoiCash. All rights reserved.
//         </p>
//       </div>
//     </div>
//   );
...
export default function Login() {
  ...
  // Function to check if the email exists and then validate the password
  const checkUserEmail = async (e) => {
    ...
    try {
      ...
      const passwordResponse = await fetch('/api/checkPassword', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      // Proceed to login if email and password match
      window.location.href = '/dashboard'; // Example redirection

    } catch (error) {
      console.error('Error checking user email or password:', error);
